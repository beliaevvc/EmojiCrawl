...
const CoinCardItem = ({ 
    ...
    <div className="flex flex-col items-center gap-2 relative group" style={{ margin: '10px' }}>
        <div className="relative">
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border-4 border-amber-500/50 bg-amber-900/20 flex items-center justify-center text-3xl md:text-4xl shadow-lg relative overflow-visible">
                <span className="z-10 select-none">💎</span>
                
                {/* Value Badge - Bottom Center */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 bg-stone-900 border-2 border-amber-500 rounded-full w-10 h-10 flex items-center justify-center z-10 shadow-md">
