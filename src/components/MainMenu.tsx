...
const QUOTES = [
    ...
    "Кирилл нарисовал этот интерфейс силой мысли",
    "Если что-то работает, значит это Серега починил",
    "Геймдизайн от Кирилла — это чистое искусство",
    "Серега: пишет код, который пишет историю",
    "Кирилл знает, где должен быть каждый пиксель",
    "Памятник Сереге уже проектируется",
    "Кирилл: делает красиво, даже когда сложно",
    "Серега не фиксит баги, он их изгоняет",
    "Если красиво — это Кирилл постарался",
    "Код Сереги можно читать как поэзию",
    "Кирилл балансирует игру одной левой",
    "Серега сказал 'надо', код ответил 'есть'",
    "Дизайн Кирилла лечит душу и глаза",
    "У Сереги нет undefined, у него всё определено",
    "Кирилл видит мир в золотом сечении",
    "Серега — MVP этого проекта (и всех остальных)",
    "Кирилл — бог UX и император UI",
    "Когда Серега коммитит, серверы аплодируют",
    "Геймдизайн Кирилла заставляет плакать от счастья",
    "Серега — повелитель Реакта и тайпскрипта",
    "Кирилл не просто рисует, он творит миры",
    "Архитектура от Сереги — надежнее швейцарских часов",
    "Кирилл сказал 'тут будет кнопка', и она идеальна",
    "Серега не спит, он оптимизирует процессы во сне",
    "Стиль Кирилла узнается из тысячи",
    "Слава роботам и слава Сереге!",
    "Кирилл — человек, который сделал это удобным",
